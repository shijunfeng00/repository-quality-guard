...
正式源码、测试、fixture、artifact path、配置和运行分支应描述稳定能力、协议与领域身份，而不是某次发布的版本、RC、Git tag、commit SHA 或固定实现 digest。README.md 与 README_zh.md 可面向人类说明当前版本，因此是仅有的文档豁免；仓库外独立 release evidence 不进入扫描域。
